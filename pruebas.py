...
def cargarDatos():
 ...
 # Sirve para saber en que cuatrianual estamos sabiendo que empezamos en 1995
    contCuatrienal = 1
...
def consulta():
    ...
    cursor.execute("SELECT DISTINCT idJornada FROM datosMercadoLaboral")
    resultados=cursor.fetchall()

    for fila in resultados:
        print(fila)

    cursor.execute("SELECT DISTINCT idEstudio FROM datosMercadoLaboral")
    resultados=cursor.fetchall()

    print('idEstudios distintos')
